...
import { Button, ButtonTypes, ButtonVariants, IconTypes } from '.';
...
export const WithIconAndText = () =>
  <div style={{ display: 'flex', flexDirection: 'column', gap: '1em' }}>
    ...
    <Button type={ButtonTypes.Secondary} icon={IconTypes.Change} text="Change Assistant" onClick={action('onClick')}/>
    <Button type={ButtonTypes.Secondary} icon={IconTypes.Skin} text="Change Skin" onClick={action('onClick')}/>
  </div>;

export const Liquid = () =>
  <div style={{ display: 'flex', width: '90vw' }}>
    <Button type={ButtonTypes.Primary} variant={ButtonVariants.Liquid} text="Confirm" onClick={action('onClick')}/>
  </div>
